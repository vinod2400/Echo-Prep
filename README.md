# 🎯 EchoPrep - AI-Powered Mock Interview Platform
...
- ✅ **Instant Feedback** - AI-powered analysis of answers with scores and suggestions
- ✅ **Multiple Job Roles** - Web Developer, App Developer, ML/AI Engineer, UX Designer, Data Scientist
- ✅ **Experience Levels** - Fresher, Junior, Mid-level, Senior
- ✅ **HR Dashboard** - Schedule and manage candidate interviews
- ✅ **Interview Rooms** - Unique links for scheduled interviews with timer
- ✅ **Performance Analytics** - Track scores, strengths, and areas for improvement
